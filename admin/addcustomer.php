...
?>
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="admin_dashboard.php">Dashboard</a></li>
    <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="customer.php">customer</a></li>
    <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="#">Add Customer</a></li>
  </ol>
</nav>
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2" style="font-size:15px;">Add Customers</h1>
    ...
    <div style="width: 60%; margin-left:20%; background-color:ligt green;align:" > 
       <!-- #BEB4BE -->
    <div id="msg"></div>
      <form action=""  method="post" style="margin:1%; padding: 10%;color:hsl(0, 100%, 30%);font-size:13px;" name="customer_form" id="customer_form">

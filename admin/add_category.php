...
?>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="category.php">Category</a></li>
    <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="#">Add Category</a></li>
  </ol>
</nav>
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2" style="font-size:15px;">Add Category</h1>

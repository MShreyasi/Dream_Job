...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="#">Jobs</a></li>
   
 </ol>
</nav>
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
 <h1 class="h2" style="font-size:25px;">All Jobs</h1>
       <div class="btn-toolbar mb-2 mb-md-0">
         <div class="btn-group mr-2">
          
         </div>
        <a class="btn btn-primary" href="add_create_job.php" style="font-size:25px;">Create job</a>
       </div>
     </div>

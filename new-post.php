...
<html lang="en">
  ...
  <body class="text-center" >
    <form class="form-signin" action="new-post.php" method="post" style=" background-color: #9370DB;padding: 20px 25px;border-radius: 12px;margin: auto;width:35rem;">
      ...
      <a href="admin/admin_login.php" style="color: white;">Super Admin</a>

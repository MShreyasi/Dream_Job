...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
 ...
 <ol class="breadcrumb">
   <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="my_profile.php">Profile</a></li>  
   <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="#">Status</a></li>

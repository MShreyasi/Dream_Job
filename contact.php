    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Yalahanka New Town Banglore</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">9445454545</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@yoursite.com">e60@gamil.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">DreamJObs.com</a></p>
          </div>
        </div>

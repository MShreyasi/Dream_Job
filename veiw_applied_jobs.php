...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
 ...
 <ol class="breadcrumb">
   <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="view_status.php">Status</a></li>  
   <li class="breadcrumb-item" style="color:#4d79ff;font-size:15px;"><a href="#">Applied Jobs</a></li>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
 <h1 class="h2">Application</h1>
     ...
     <!--  -->
     <form action="" method="post" style="border: 1px solid gray; width: 80%; margin-left: 10% ;padding: 10px;font-size:15px">
       <?php
include('connection/db.php');
$id=$_GET['id'];
...
?>
 <h1 style="font-size:25px;"><?php echo strtoupper($row['first_name']); ?> <?php echo strtoupper($row['last_name']); ?></h1>
<br>

...
<!-- <div style="background-color:#008B8B;"> -->
  <div id="id_all_jobs" >
    <section class="ftco-section bg-light" style="background-color:#DAA520;">
			<div class="container">
       ...
       while($row=mysqli_fetch_array($sql)){ ?>
					...
					<div class="col-md-12 ftco-animate" style="border-color: red;" >

            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center" style="border-color: red;">
    ...
    <section class="ftco-section services-section bg-light" style=" background-color: rgb(98 255 0 / 37%);">
      <div class="container" style=" background-color: rgb(98 255 0 / 37%);">
        <div class="row d-flex">
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              <div class="icon"><span class="flaticon-resume"></span></div>
              <div class="media-body">
                <h3 class="heading mb-3">Search Your Dream Job</h3>

...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" action="job-post.php" method="post" style=" background-color: #9370DB;padding: 20px 25px;border-radius: 12px;margin: auto;width:35rem;" > 
      ...
      <a href="sign_up.php" style="color: white;">Create Account</a>

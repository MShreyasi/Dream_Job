...
?>
<br>
<div style="margin-left: 25%; width: 50%; border: 1px solid gray; padding: 10px;color:white;background-color: #0e2a48cf;;">
...
<div class="col-md-6">
<td><a href="view_status.php" class=" btn btn-success" >Status</a></td>

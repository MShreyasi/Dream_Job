...
<html lang="en">
  ...
  var regex = /^[a-zA-Z\s]*$/; // regular expression for letters and spaces only
  ...
  if (firstName.length < 2 || !regex.test(firstName)) {
    document.getElementById("first_name_error").innerHTML=alert("Please enter a valid first name.");
    return false;
  }
  if (lastName < 1 || !regex.test(firstName)) {
    document.getElementById("first_name_error").innerHTML=alert("Please enter a valid last name.");
    return false;
  }
  if(!regexPhone.test(mobile)){
    document.getElementById("mobile_number_error").innerHTML=alert("Please enter a valid Phone NO.");
    return false;
  }
  return true;
}
 ...
 #ce954b;color:white;padding: 50px 55px;border-radius: 50px;margin: auto;width:65rem;">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3" style="color: #35354c;font-size:65px"><td><?php echo $title; ?></td></h2>
            <h5  style="color:#35354c;font-size:35px"><?php echo $country ;?>,<?php echo $state; ?>, <?php echo $city; ?></h5>
            <p><?php echo $des; ?></p>
            
            <form action="apply_job.php" method="post" id="JobPortal" enctype="multipart/form-data"   style=" background-color: var(--gray-dark); border: 1px solid gray" >
            <div style="padding: 2%;">
...
<div class="col-sm-6">
         ...
         <input type="text" class="form-control" name="mobile_number" id="mobile_number" placeholder="Phone_no" required>
         <span class="error" id="mobile_number_error"></span> 
         </div>
<div class="col-sm-6">

<label for="">Choose Photo</label>
<input type="file" class="form-control" name="filea" id="filea" required>
 
</div>
<div class="col-sm-6">

<label for="">Choose Id proof</label>
<input type="file" class="form-control" name="fileb" id="fileb" required>
...
<input type="text" class="form-control" value="<?php echo $_SESSION['email']; ?>" disabled>
  ...
  <br>
       ...
       <input type="submit" name="submit" id="submit" value="submit" placeholder="Submit" class="btn btn-primary btn-block " onclick="return validateForm()"> 
  </div>  
  </div>
  </form>    
